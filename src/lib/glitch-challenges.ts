...
const challenges: Record<string, GlitchChallenge[]> = {
  ai_basics: [
    ...
    },
    {
      ...
      options: ['Supervised learning', 'Neural networks', 'Quantum entanglement', 'Deep learning'],
      correct: 2,
      difficulty: 'medium',
      category: 'ai_basics',
    ...
    },
    {
      ...
      category: 'ai_basics',
      explanation:
        'Silná AI (AGI) by měla mít obecnou inteligenci a potenciálně vědomí, zatímco slabá AI řeší specifické úlohy.',
    },
  ],
  algorithms: [
    {
      ...
      explanation:
        'BFS má časovou složitost O(V + E), kde V je počet vrcholů a E počet hran v grafu.',
    },
    {
      id: 'algo_002',
      ...
      category: 'algorithms',
      explanation:
        'Heuristika v A* je funkce, která odhaduje vzdálenost od aktuálního uzlu k cíli.',
    },
  ],
  machine_learning: [
    {
      ...
      explanation:
        'Overfitting nastává, když se model příliš přizpůsobí trénovacím datům a ztrácí schopnost generalizace.',
    },
    {
      id: 'ml_002',
      question: 'Který algoritmus NENÍ supervizované učení?',
      options: ['Lineární regrese', 'K-means clustering', 'Random Forest', 'SVM'],
      correct: 1,
      difficulty: 'hard',
      category: 'machine_learning',
      hint: 'Hledej algoritmus, který nepotřebuje značená data.',
      explanation:
        'K-means clustering je algoritmus nesupervizovaného učení, nepotřebuje značená data.',
    },
  ],
  neural_networks: [
    {
    ...
    },
    {
      ...
      explanation:
        'Dropout je regularizační technika, která náhodně "vypíná" neurony během trénování.',
    },
  ],
  programming: [
    {
    ...
    },
    {
      ...
      explanation:
        'Python dictionary má průměrnou časovou složitost O(1) pro přístup k prvkům díky hash tabulce.',
    },
  ],
}
